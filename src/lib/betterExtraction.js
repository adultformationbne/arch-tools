...
export function fixChapterStructure(brokenChapter) {
	...
	brokenChapter.blocks.forEach((block) => {
		...
		if (
			block.content.includes('What is the basic rule') ||
			...
			if (beforeFirstSection.trim()) {
				...
				const introParagraphs = beforeFirstSection.split(
					/(?=We Catholics place|The New Testament narratives)/
				);
