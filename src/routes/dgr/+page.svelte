  ...
  async function handleSubmit(e) {
    ...
    const toastId = toast.multiStep({
      steps: [
        ...
        { title: 'Connecting to WordPress...', message: 'Establishing secure connection', type: 'info' },
  ...
  function parseWordDocument(text) {
    ...
    if (sections.gospelQuote) {
      ...
      if (refMatch) {
        ...
        sections.gospelQuote = sections.gospelQuote.replace(/\s*\([^)]+\)\s*$/, '').replace(/['']/g, "'").replace(/[""]/g, '"');
      }
    }
...
<div class="max-w-3xl mx-auto p-6">
  ...
  <div class="mb-8 p-4 bg-gray-50 rounded-lg">
    <h2 class="text-lg font-semibold mb-3">Toast Notification Examples</h2>
  ...
  <form onsubmit={handleSubmit} class="space-y-6">
    <div class="bg-white shadow-sm rounded-lg p-6 space-y-4">
      <h2 class="text-xl font-semibold text-gray-800 mb-4">Reflection Details</h2>
    ...
    <div class="bg-white shadow-sm rounded-lg p-6 space-y-4">
      <h2 class="text-xl font-semibold text-gray-800 mb-4">Gospel Content</h2>
    ...
    <div class="bg-white shadow-sm rounded-lg p-6 space-y-4">
      <h2 class="text-xl font-semibold text-gray-800 mb-4">Reflection</h2>
