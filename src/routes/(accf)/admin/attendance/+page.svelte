						...
						<div class="bg-white rounded-2xl shadow-sm overflow-hidden">
							...
							>
								<div class="flex items-center gap-4">
									<div class="w-10 h-10 rounded-lg flex items-center justify-center font-bold text-white" style="background-color: #334642;">
										{sessionNum}
									</div>
									<div class="text-left">
												...
												{#each attendanceData.nonHubStudents as student}
													...
													<div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
														<div class="flex items-center gap-3">
															<div class="w-10 h-10 rounded-full flex items-center justify-center font-semibold text-white text-sm" style="background-color: #334642;">
