...
<div class="px-16 py-8">
	...
	<div class="flex items-center justify-between mb-8">
		<div>
			<h1 class="text-3xl font-bold" style="color: var(--course-accent-dark);">Courses</h1>
	...
	{#if courses.length === 0}
		<div class="text-center py-16">
			...
			<h3 class="text-xl font-semibold mb-2" style="color: var(--course-accent-dark);">No courses yet</h3>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
			{#each courses as course}
				...
				>
					...
					<!-- Stats -->
					<div class="grid grid-cols-3 gap-4 pt-4 border-t" style="border-color: var(--course-surface);">
						...
						<div class="text-center">
							<div class="flex items-center justify-center mb-1">
								<Users size={16} style="color: var(--course-accent-light);" />
							</div>
							<div class="text-2xl font-bold" style="color: var(--course-accent-dark);">
