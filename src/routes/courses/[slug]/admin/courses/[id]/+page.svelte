...
$effect(() => {
 if (course && !editing) {
  ...
  editStatus = course.status ?? 'draft';
 }
});
...
<div class="px-16 py-8">
			...
			<div class="flex-1">
				{#if editing}
					<input
						...
						style="color: var(--course-accent-dark); border-color: var(--course-surface);"
					/>
					<input
						type="text"
	...
	<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
		<div class="bg-white border rounded-lg p-6" style="border-color: var(--course-surface);">
			<div class="flex items-center gap-3 mb-2">
				<BookOpen size={24} style="color: var(--course-accent-light);" />
				<span class="text-sm font-semibold text-gray-600">Modules</span>
			</div>
			<div class="text-3xl font-bold" style="color: var(--course-accent-dark);">{modules.length}</div>
		</div>

		<div class="bg-white border rounded-lg p-6" style="border-color: var(--course-surface);">
			<div class="flex items-center gap-3 mb-2">
				<Calendar size={24} style="color: var(--course-accent-light);" />
				<span class="text-sm font-semibold text-gray-600">Cohorts</span>
			</div>
			<div class="text-3xl font-bold" style="color: var(--course-accent-dark);">{cohorts.length}</div>
		...
		<div class="bg-white border rounded-lg p-6" style="border-color: var(--course-surface);">
			<div class="flex items-center gap-3 mb-2">
				<Users size={24} style="color: var(--course-accent-light);" />
				<span class="text-sm font-semibold text-gray-600">Enrollments</span>
			</div>
			<div class="text-3xl font-bold" style="color: var(--course-accent-dark);">{totalEnrollments}</div>
		</div>
	</div>

	<!-- Tabs -->
	<div class="border-b mb-6" style="border-color: var(--course-surface);">
		<nav class="flex gap-8">
			<button
				...
				style:border-color={activeTab === 'overview' ? 'var(--course-accent-light)' : 'transparent'}
				style:color={activeTab === 'overview' ? 'var(--course-accent-dark)' : undefined}
			>
				Overview
			</button>
			<button
				...
				style:border-color={activeTab === 'modules' ? 'var(--course-accent-light)' : 'transparent'}
				style:color={activeTab === 'modules' ? 'var(--course-accent-dark)' : undefined}
			>
			...
			<button
				...
				style:border-color={activeTab === 'cohorts' ? 'var(--course-accent-light)' : 'transparent'}
				style:color={activeTab === 'cohorts' ? 'var(--course-accent-dark)' : undefined}
			>
	...
	{#if activeTab === 'overview'}
		<div class="space-y-6">
			{#if editing}
				<div>
					<label class="block text-sm font-semibold mb-2" for="course-description" style="color: var(--course-accent-dark);">
						Description
					</label>
					<textarea
			...
			{:else if course.description}
				<div class="bg-white border rounded-lg p-6" style="border-color: var(--course-surface);">
					<h3 class="text-lg font-semibold mb-3" style="color: var(--course-accent-dark);">Description</h3>
			...
			{#if course.duration_weeks}
				<div class="bg-white border rounded-lg p-6" style="border-color: var(--course-surface);">
					<h3 class="text-lg font-semibold mb-3" style="color: var(--course-accent-dark);">Duration</h3>
	...
	{:else if activeTab === 'modules'}
		<div>
			...
			{#if modules.length === 0}
				<div class="text-center py-12 bg-white border rounded-lg" style="border-color: var(--course-surface);">
				...
				<div class="space-y-4">
					{#each modules as module}
						<div class="bg-white border rounded-lg p-6" style="border-color: var(--course-surface);">
							<div class="flex items-start justify-between">
								<div class="flex-1">
									<h4 class="text-lg font-semibold mb-2" style="color: var(--course-accent-dark);">
										{module.name}
									</h4>
								...
								<a
									...
									style="border-color: var(--course-accent-light); color: var(--course-accent-dark);"
								>
									Manage
								</a>
							</div>
	...
	{:else if activeTab === 'cohorts'}
		<div>
			...
			{#if cohorts.length === 0}
				<div class="text-center py-12 bg-white border rounded-lg" style="border-color: var(--course-surface);">
					<Calendar size={48} class="mx-auto mb-4" style="color: var(--course-accent-light);" />
					...
					{#each cohorts as cohort}
						<div class="bg-white border rounded-lg p-6" style="border-color: var(--course-surface);">
							<div class="flex items-start justify-between">
								<div class="flex-1">
									<div class="flex items-center gap-3 mb-2">
										<h4 class="text-lg font-semibold" style="color: var(--course-accent-dark);">
											{cohort.name}
										</h4>
										<span
