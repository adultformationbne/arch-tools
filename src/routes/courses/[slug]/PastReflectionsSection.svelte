<script>
	import { ChevronRight, ArrowRight, HelpCircle, MessageSquare, Star, Edit3 } from '$lib/icons';
	...
	{:else}
		...
		<div class="text-center py-16">
			...
			<p class="text-white opacity-75 max-w-md mx-auto">
				Your submitted reflections will appear here. Start writing your first reflection from the session overview above.
			</p>
		</div>
	{/if}
